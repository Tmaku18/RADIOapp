  ...
  const handleSend = async () => {
    ...
    try {
      ...
      if (editingMessageId && body) {
        ...
        await messagesApi.sendMessage(selectedOther.userId, payload);
      }
      setDraft('');
      setAttachment(null);
            ...
            {!selectedOther ? (
              ...
              <>
                <div className="p-3 border-b border-border/60 flex items-center gap-3">
                  ...
                  <div className="ml-auto flex items-center gap-2">
                    <span className="inline-flex items-center gap-2 text-xs text-muted-foreground">
                      ...
                      {typingOther ? 'typing...' : selectedUnread > 0 ? `${selectedUnread} unread` : 'Live'}
                    </span>
                  </div>
                </div>
                ...
                <div className="p-3 border-t border-border/60 space-y-2">
                  ...
                  <Input
                    placeholder={editingMessageId ? 'Edit message...' : 'Send a Ripple…'}
                    value={draft}
