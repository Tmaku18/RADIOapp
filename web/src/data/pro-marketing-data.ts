...
export const proDisciplines: ProDiscipline[] = [
  ...
  { icon: 'Brush', label: 'Illustrators', count: 14, color: 'cyan' as const },
  { icon: 'Mic', label: 'Lyricists', count: 22, color: 'pink' as const },
  { icon: 'Drum', label: 'Beat Makers', count: 29, color: 'yellow' as const },
  { icon: 'SlidersHorizontal', label: 'Engineers', count: 12, color: 'cyan' as const },
  { icon: 'Shirt', label: 'Stylists', count: 9, color: 'pink' as const },
];
...
export const proDirectoryRoles = [
  'All',
  'Graphic Designer',
  'Photographer',
  'Beat Maker',
