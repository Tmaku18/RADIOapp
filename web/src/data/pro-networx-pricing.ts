...
export const PRO_NETWORX_MESSAGING_BETA_PROMO =
  `Messaging is free during beta. Pro-Networx is ${PRO_NETWORX_INTRO_DISPLAY} first month, then ${PRO_NETWORX_REGULAR_DISPLAY}/mo — or Pro Bundle (Radio + Networx) for $12.99/mo.`;
