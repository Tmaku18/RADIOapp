  ...
  return (
    <div className="container max-w-6xl py-8 space-y-6">
      {loading ? (
        ...
        <>
          <Card className="glass-panel border border-border overflow-hidden">
                        ...
                        <Card key={p.id} className="overflow-hidden border border-border bg-card">
                          <CardContent className="pt-5 space-y-2">
                            {p.type === 'image' && (
                              ...
                              <img src={p.fileUrl} alt={p.title ?? 'Portfolio'} className="w-full h-40 object-cover rounded-md border border-border" />
                            )}
                            {p.type === 'video' && (
                  ...
                  {activeListings.length === 0 ? (
                    ...
                    <div className="space-y-3">
                      {activeListings.map((l) => (
                        <Card key={l.id} className="border border-border bg-card">
