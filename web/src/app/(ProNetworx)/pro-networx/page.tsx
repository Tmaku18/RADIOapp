...
export const metadata = {
  title: 'ProNetworx — The Collective Directory | Networx',
  description:
    'Hire and collaborate with artists, producers, studios, designers, and more. LinkedIn-style profiles and Fiverr-style gigs. Industry Catalysts on Networx.',
};
      ...
      <section className="relative py-20 sm:py-28 overflow-hidden bg-signature">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-6 text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto">
            PRO-NETWORX is the professional layer on Networx: <span className="text-foreground">Catalysts</span> with LinkedIn-style profiles and Fiverr-style gigs. Find producers, designers, and mentors—skill-first.
          </p>
          <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
            <Button asChild size="lg" className="bg-primary text-primary-foreground hover:opacity-90 shadow-[var(--brand-glow)]">
              <Link href="/login?redirect=%2Fpro-networx%2Fdirectory">Log in</Link>
            </Button>
            <Button asChild size="lg" variant="secondary">
              <Link href="/signup?redirect=%2Fpro-networx%2Fdirectory">Sign up</Link>
            </Button>
      ...
      <section className="py-16">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-muted-foreground mb-6">
            Join Networx to browse the directory, message Catalysts, and build your Sync-Profile.
          </p>
