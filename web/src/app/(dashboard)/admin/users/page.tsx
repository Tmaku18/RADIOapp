        ...
        <div className="flex flex-wrap gap-3 items-center w-full lg:w-auto">
          ...
          <div className="relative w-full sm:w-64">
            <input
              ...
              className="pl-9 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary w-full"
            />
                  ...
                  <td className="px-6 py-4 text-right">
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end" className="min-w-[160px] text-foreground [&_*]:text-foreground">
                        ...
                        <DropdownMenuItem
                          onClick={() => handleRoleChange(user.id, 'musician')}
                          className="text-foreground focus:text-foreground focus:bg-accent cursor-pointer"
                        >
                          Set as Musician
                        </DropdownMenuItem>
