-- Seed Rideshare Radio fallback playlist from Clean Rap so the station has
-- family-safe free-rotation content for drivers and passengers. Idempotent.
...
WHERE radio_id = 'us-rap-clean'
  AND NOT EXISTS (
    SELECT 1 FROM admin_fallback_songs b2
    WHERE b2.radio_id = 'us-rideshare'
