...
export class AdminService {
  ...
  getRadios(
    ...
    const radios = [
      ...
      { id: 'us-spoken-word', state: 'US', label: 'Spoken Word' },
      { id: 'us-comedian', state: 'US', label: 'Comedian' },
      { id: 'us-gospel', state: 'US', label: 'Gospel' },
      { id: 'us-classical', state: 'US', label: 'Classical Radio' },
      { id: 'us-emo', state: 'US', label: 'Emo Radio' },
      { id: 'us-ai-created', state: 'US', label: 'AI Created Radio' },
      { id: 'us-beats', state: 'US', label: 'Beats Radio' },
      { id: 'us-freestyle', state: 'US', label: 'Freestyle Radio' },
      { id: 'us-instrumental', state: 'US', label: 'Instrumental Radio' },
      { id: 'us-lofi', state: 'US', label: 'Lo-Fi Radio' },
