...
/// Subscribe to Pro-Radio ($4.99/mo) or Pro Bundle ($12.99/mo for Radio + Networx).
...
class _ProRadioPaywallSheetState extends State<ProRadioPaywallSheet> {
  ...
  void initState() {
    super.initState();
    if (isMobileStorePlatform) unawaited(_prefetchStoreProducts());
  }
  ...
  Future<void> _prefetchStoreProducts() async {
    ...
    try {
      ...
      try {
        ...
        // Bundle SKU may not be live in the store yet.
      }
      if (!mounted) return;
      setState(() {
      ...
      setState(() {
        ...
        _error = PlayBillingService.instance.describeStoreError(
          e,
          productId: PlayBillingService.instance.proRadioMonthlyProductId,
        );
      });
    }
  }
  ...
  Future<void> _subscribeWithStripe() async {
    final res = _plan == _ProPlan.bundle
        ...
        : await _service.createPaymentSheet();
    ...
    await Stripe.instance.initPaymentSheet(
      paymentSheetParameters: SetupPaymentSheetParameters(
        ...
        merchantDisplayName:
            _plan == _ProPlan.bundle ? 'Pro Bundle' : 'Pro-Radio',
