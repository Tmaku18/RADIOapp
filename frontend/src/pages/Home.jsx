        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-10 py-32 w-full">
          <div className="max-w-3xl">
            ...
            <h1 className="font-unbounded font-black tracking-tighter uppercase text-5xl md:text-7xl lg:text-8xl leading-[0.9]">
              ...
              <span className="block text-glow-cyan text-cyan-300">movement.</span>
              <span className="block">Build your</span>
              <span className="block glitch text-glow-pink" data-text="network.">network.</span>
            </h1>
          ...
          {glossary.map((g, i) => {
            ...
            return (
              <div
                ...
                className="tracing-border rounded-2xl glass p-7"
              >
